...
Humanoid.DisplayDistanceType: number
Humanoid.HealthDisplayDistance: number
Humanoid.HealthDisplayType: number
Humanoid.MoveToPoint: Vector3
Humanoid.NameDisplayDistance: number
Humanoid.NameOcclusion: number
...
Humanoid.FloorMaterial: number
Humanoid.RootPart: BasePart?
Humanoid.IsWalking: boolean
Humanoid.MoveDirection: Vector3
Humanoid.MoveToPart: BasePart?
Humanoid.RigType: number
